...
\author{Wilbert J. Fletcher$^{1,*}$, Jonathan Schultz$^{2}$, Timothy Mulrooney$^{3}$ \\
$^{1}$Department of Geographic Information Systems, Institution Name \\
$^{2}$Department of Occupational Health and Safety, Institution Name \\
$^{3}$Department of Public Health, Institution Name \\
$^{*}$Corresponding author: \texttt{wilbert.fletcher@institution.edu}}
